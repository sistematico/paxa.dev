...
function Snippet() {
  ...
  return (
    <div className="container mx-auto px-4 py-8 max-w-4xl">
      <Link to="/snippets" className="border-2 border-black/50 py-2 ps-1.5 pe-4 rounded-lg inline-flex items-center gap-2 hover:bg-black/20 transition-colors duration-800 mb-8 uppercase">
        <ArrowLeft /> Voltar
      </Link>
      {/* <Link 
        to="/snippets" 
