      ...
      <div className="max-w-4xl mx-auto text-sm sm:text-md px-1 py-4 md:px-6 md:py-16">
        ...
        <div className="prose prose-lg dark:prose-invert mx-auto text-slate-700 dark:text-slate-300 space-y-6">
          <p className="md:text-xl leading-relaxed">
            Como um <span className="text-amber-600 dark:text-amber-400 font-semibold">nômade digital</span> atravessando 
            as dunas infinitas da web desde 1997, transformo linhas de código em oásis de funcionalidade.
          </p>

          <p className="md:text-lg leading-relaxed">
            Há mais de <span className="font-bold text-orange-600 dark:text-orange-400">duas décadas</span>, navego 
            pelos desertos do Linux (desde 1999), dominando tempestades de servidores e arquitetando caravanas 
            de aplicações que cruzam do frontend ao backend sem perder uma gota de performance.
          </p>
          ...
          <p className="md:text-lg leading-relaxed">
            ...
            </span>, e guardião de segredos em{" "}
            <span className="text-orange-600 dark:text-orange-400 font-semibold">
              Docker, Git, Node.js e Bun
            </span>. 
            Como um verdadeiro Paxá do código, comando meus domínios com Shell Script, Python, 
            e até mesmo exploro as terras de Rust e Go.
          </p>

          <p className="md:text-lg leading-relaxed">
            Neste oásis digital, você encontrará tesouros escondidos: snippets preciosos como especiarias raras, 
            projetos que brilham como estrelas no céu noturno do deserto, e conhecimentos ancestrais (bem, desde os anos 90) 
            sobre administração de sistemas e desenvolvimento web.
          </p>
